...
apt-get update
apt-get -y install --no-install-recommends libncurses5:i386 libpulse0:i386 libdbus-1-3:i386 libsdl2-2.0-0:i386 software-properties-common winbind zenity 2>&1
EOT
