...
This is a Docker image based on [rubensa/ubuntu-tini-x11](https://github.com/rubensa/docker-ubuntu-tini-x11) 20.04 that includes [Wine](https://www.winehq.org/).
...
bash -c "docker run --rm -it \
  ...
  ${RUNNER} \
  ${RUNNER_GROUPS} \
  rubensa/ubuntu-tini-wine:20.04"
```
